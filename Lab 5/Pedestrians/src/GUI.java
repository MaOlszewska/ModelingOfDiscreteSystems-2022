...
public class GUI extends JPanel implements ActionListener, ChangeListener {
	...
	public void initialize(Container container) {
		...
		types = new JComboBox (Board.neighTypes);
		types.addActionListener(this);
		types.setActionCommand("typeNeigh");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(timer)) {
			...
			else if(command.equals("typeNeigh")){
				if(Objects.equals((String) types.getSelectedItem(), "Moore")){
					board.type = 1;
				}
				else if(Objects.equals((String) types.getSelectedItem(), "Neuman")){
					board.type = 0;
				}
